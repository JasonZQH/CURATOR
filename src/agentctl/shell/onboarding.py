...
from agentctl.providers.detect import detect_available_providers, provider_setup_hint
from agentctl.providers.profiles import RuntimeMode, resolve_runtime_mode
...
def apply_first_run_init(project_root: Path | str) -> str:
    ...
    """
    from agentctl.app import write_init_state
